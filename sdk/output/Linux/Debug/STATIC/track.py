...
class Track:
    ...
    def track(self, threshold):
        ...
        # frame1_m_cart = self.convert(self.frames[0])
        # for m in self.compute_mean(frame1_m_cart):
        #     track.append([m])

        # print("MEAN-VALUES IN FRAME-0")
        # print("TRACK:")
        # pprint(track)


        frame1_cart = self.convert(self.frames[0])
